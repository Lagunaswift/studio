...
import {
  LayoutDashboard, UtensilsCrossed, CalendarDays, Sparkles, ShoppingBag, UserCog, Settings
} from 'lucide-react';
...
const sections: GuideSection[] = [
  {
    ...
    content: [
      ...
      "The dashboard also features a random <strong>Featured Recipe</strong> from your collection to inspire your next meal."
    ]
  },
  {
    ...
    content: [
      ...
      "You can use the <strong>search bar</strong> to find recipes by name, description, or tags.",
      ...
      "Click on any recipe card to view its <strong>full details</strong>, including ingredients, instructions, and macros per serving.",
  ...
  },
  {
    ...
    content: [
      ...
      "Click 'Generate My AI Meal Plan'. The AI will consider your profile and available recipes to create a balanced one-day meal plan.",
  ...
  },
  {
    ...
    content: [
      "The <strong>Shopping List</strong> is automatically generated based on the meals you've added to your Meal Plan.",
      "As you add or remove meals, the shopping list updates to reflect the required ingredients and their quantities.",
      "You can check off items as you purchase them. Use the 'Store-Friendly Quantities' toggle to see amounts more aligned with typical supermarket packaging (e.g., '1 box of 6 eggs' instead of '5 eggs').",
  ...
  },
  {
    ...
    content: [
      ...
      "<strong>User Info:</strong> Basic details like name, email, height, weight, age, sex, and activity level. This data helps calculate your TDEE (Total Daily Energy Expenditure) and LBM (Lean Body Mass), which can guide your macro targets.",
      "<strong>Targets:</strong> Set your daily caloric and macronutrient (protein, carbs, fat) goals here. The AI can help suggest protein intake based on your LBM and goals.",
              ...
              <AccordionContent className="p-6 pt-0 text-base">
                <div className="space-y-3 text-foreground/90">
                  {section.content.map((paragraph, pIndex) => (
                    <p key={pIndex} dangerouslySetInnerHTML={{ __html: paragraph.replace(/<Link href='([^']*)' class='([^']*)'>(.*?)<\/Link>/g, "<a href='$1' class='$2'>$3</a>") }} />
                  ))}
                </div>
              </AccordionContent>
            </AccordionItem>
