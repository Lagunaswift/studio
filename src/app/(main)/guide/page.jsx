...
import { LayoutDashboard, UtensilsCrossed, CalendarDays, Sparkles, ShoppingBag, UserCog, Settings, Archive, AlertTriangle } from 'lucide-react';
const sections = [
    {
...
export default function GuidePage() {
    return (<PageWrapper title="Welcome to MealPlannerPro! Your App Guide">
      ...
      <Accordion type="single" collapsible className="w-full space-y-4">
        {sections.map((section, index) => (<Card key={index} className="shadow-md overflow-hidden">
