...
export default function ShoppingListPage() {
  ...
  const handleClearList = () => {
    // This currently clears all data including meal plan, as shopping list is derived.
    // Future improvement: Clear only shopping list (e.g., mark all as purchased or truly empty it).
    // For now, it clears everything to ensure consistency.
    clearAllData(); 
    toast({
