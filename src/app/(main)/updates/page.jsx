...
export default function UpdatesAndFeedbackPage() {
    ...
    return (<PageWrapper title="Updates & Feedback">
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-4">
            <Textarea placeholder="Please describe the bug in detail. What were you doing? What did you expect to happen? What actually happened?" rows={6} value={bugDescription} onChange={(e) => setBugDescription(e.target.value)} disabled={isSubmitting}/>
            {submissionResult && (<Alert variant={submissionResult.success ? 'default' : 'destructive'} className={submissionResult.success ? 'border-green-500' : ''}>
