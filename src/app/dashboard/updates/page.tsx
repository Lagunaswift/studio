...
export default function UpdatesAndFeedbackPage() {
  ...
  const handleBugSubmit = async () => {
    ...
    try {
      const result = await reportBug(bugDescription, user.uid);
      if (result.error) {
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <Card className="shadow-lg">
          <CardHeader>
            ...
            <CardDescription>
              Found something that's not working right? Let us know! We'll categorize and prioritize your report to help us fix it faster.
            </CardDescription>
          </CardHeader>
