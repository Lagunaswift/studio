...
export default function DashboardSettingsPage() {
  const { userData: userProfile, updateUserData } = useAuth();
  ...
  const onSubmit: SubmitHandler<DashboardSettingsFormValues> = async (data) => {
    await updateUserData({ dashboardSettings: data as DashboardSettings });
    toast({
