...
export function ProFeature({ featureName, description, hideWrapper = false }) {
    ...
    const content = (<div className="text-center p-4 sm:p-6 md:p-8 flex flex-col items-center">
    ...
    return (<Card className="shadow-lg border-dashed border-accent">
