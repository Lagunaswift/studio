...
import { Bot, Loader2, Send, Sparkles, Lock } from 'lucide-react';
import { askPreppyAboutApp, type AppGuideInput, type AppGuideOutput } from '@/ai/flows/app-guide-flow';
...
export function PreppyHelp() {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const input: AppGuideInput = { question };
      const result: AppGuideOutput = await askPreppyAboutApp(input);
    ...
    return (
      <>
        ...
        <div className="py-4 space-y-4">
          <Textarea
            placeholder="e.g., How do I add a recipe to my meal plan?"
            value={question}
